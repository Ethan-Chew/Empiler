        ...
        <div className="min-h-screen font-sans flex flex-col justify-between">
            ...
            <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-6 py-6">
                    ...
                    <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center cursor-pointer hover:scale-105 transition-transform" onClick={() => navigate("/appointments/viewBooking")}>
            ...
            {/* Footer Section */}
            <footer className="bg-[#677A84] w-full py-4 mt-8">
