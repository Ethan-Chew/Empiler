            ...
            <div className="flex flex-col justify-between w-[calc(67%)]">
                ...
                <div className="flex space-x-6 mt-4">
                    ...
                    <div
                        ...
                        className="cursor-pointer border border-gray-200 bg-white rounded-lg p-8 shadow-md hover:shadow-lg text-left w-[calc(50%-1rem)] h-[300px] group flex flex-col justify-between"
                    >
                        <div>
                    ...
                    <a
                        className="border border-gray-200 bg-white rounded-lg p-8 shadow-md hover:shadow-lg text-left w-[calc(50%-1rem)] h-[300px] group flex flex-col justify-between"
                        href="appointments/branches"
                    >
                        <div>
                            <div className="w-16 h-16 mb-6">
                                <PiCalendarBlank className="w-full h-full object-contain fill-ocbcred" />
                            </div>
                            <p className="text-[24px] font-semibold mb-2">Book an Appointment</p>
                            <p className="text-[18px] text-gray-500 mb-4">With our friendly staff members</p>
                        </div>
                        <div className="flex items-center text-[#D00E35] font-semibold">
